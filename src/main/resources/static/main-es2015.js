...
let AddIsbnComponent = class AddIsbnComponent {
    constructor(isbnService, router) {
...
AddIsbnComponent.ctorParameters = () => [
...
let AddProvedorComponent = class AddProvedorComponent {
    constructor(provedorService, router) {
...
AddProvedorComponent.ctorParameters = () => [
...
let EditIsbnComponent = class EditIsbnComponent {
    constructor(isbnService, router, route) {
        this.isbnService = isbnService;
        this.router = router;
        this.route = route;
    }
...
EditIsbnComponent.ctorParameters = () => [
...
let EditProvedorComponent = class EditProvedorComponent {
    constructor(provedorService, router, route) {
        this.provedorService = provedorService;
        this.router = router;
        this.route = route;
    }
...
EditProvedorComponent.ctorParameters = () => [
    { type: _shared_provedor_provedor_service__WEBPACK_IMPORTED_MODULE_4__["ProvedorService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let IsbnsListComponent = class IsbnsListComponent {
    constructor(isbnService, dialog, router) {
        this.isbnService = isbnService;
        this.dialog = dialog;
        this.router = router;
        this.isbns = [];
    ...
    confirmarExclusao(isbn) {
        const dialogRef = this.dialog.open(_shared_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmationDialogComponent"], {
...
IsbnsListComponent.ctorParameters = () => [
    { type: _shared_isbn_isbn_service__WEBPACK_IMPORTED_MODULE_2__["IsbnService"] },
...
let ProvedoresListComponent = class ProvedoresListComponent {
    constructor(provedorService, dialog) {
        this.provedorService = provedorService;
        this.dialog = dialog;
        this.provedores = [];
    ...
    confirmarExclusao(provedor) {
        const dialogRef = this.dialog.open(_shared_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_3__["ConfirmationDialogComponent"], {
...
ProvedoresListComponent.ctorParameters = () => [
    { type: _shared_provedor_provedor_service__WEBPACK_IMPORTED_MODULE_4__["ProvedorService"] },
...
let IsbnService = class IsbnService {
    constructor(http) {
        this.http = http;
    ...
    get(id) {
        ...
        return this.http.get(API_URL, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
            return res || {};
...
let ProvedorService = class ProvedorService {
    constructor(http) {
        this.http = http;
...
ProvedorService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
